...
var deployTarget = '//gallifrey/htdocs/church/';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      ...
      postBuild: {
          files: [{src: ['**/*'], cwd:'dist/', dest: deployTarget, expand: true}]
      }
    },
    dom_munger:{
      read: {
      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<script src="https://api.trello.com/1/client.js?key=79bb393fe2a5e8b6ec62a75cfb86e741"></script>'},
  ...
  grunt.registerTask('deploy',['build','copy:postBuild']);
